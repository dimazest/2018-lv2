...
\newcommand{\zenodoBase}{https://zenodo.org/record/1313727}
...
\item \texttt{LV015:} \textbf{The Chronicles of Melanie} \ Mel\=anijas Hronika (The Chronicles of Melanie) is a Latvian movie that was selected for the Foreign-Language Category for Oscars.
\item \texttt{LV006:} \textbf{Blizzard of Souls} \ A Latvian movie Dv\=ese\c{l}u Putenis (Blizzard of Souls) that is in production by the time of writing.
\end{itemize}
