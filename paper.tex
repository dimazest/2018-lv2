...
%\pretitle{Pretitle}
\title{Language Bias in Multilingual Tweet Corpora}
%\runningtitle{LV2}
%\subtitle{Subtitle}
...
Our base assumption is that geo-located tweets is a representative and unbiased sample of Latvian Twitter. Thus, an extended collection should exhibit similar properties as the geo-located one. The main property we are interested in this work is the language proportion. We hypothesize, that an unbiased extended collection should have similar language distribution as the initial.

To study the collection in more details, we defined 9 topics and manually search for relevant tweets.
